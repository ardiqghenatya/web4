				...
				if ( curr_preset['wc_settings_prdctfltr_active_filters'] !== undefined ) {
					...
					$.each(curr_preset['wc_settings_prdctfltr_active_filters'], function(index, pf_filter) {
						...
						if ( pf_filter == 'advanced' ) {
							...
							var curr_data = {
								action: 'prdctfltr_c_fields',
								pfa_title: curr_preset['wc_settings_prdctfltr_advanced_filters']['pfa_title'][curr],
								pfa_taxonomy: curr_preset['wc_settings_prdctfltr_advanced_filters']['pfa_taxonomy'][curr],
								pfa_include: curr_preset['wc_settings_prdctfltr_advanced_filters']['pfa_include'][curr],
								pfa_multiselect: curr_preset['wc_settings_prdctfltr_advanced_filters']['pfa_multiselect'][curr],
								pfa_adoptive: curr_preset['wc_settings_prdctfltr_advanced_filters']['pfa_adoptive'][curr],
								pf_id: curr
							};
							...
							var curr_data = {
								...
								pfr_title: curr_preset['wc_settings_prdctfltr_range_filters']['pfr_title'][zurr],
								pfr_taxonomy: curr_preset['wc_settings_prdctfltr_range_filters']['pfr_taxonomy'][zurr],
								pfr_include: curr_preset['wc_settings_prdctfltr_range_filters']['pfr_include'][zurr],
								pfr_style: curr_preset['wc_settings_prdctfltr_range_filters']['pfr_style'][zurr],
								pfr_grid: curr_preset['wc_settings_prdctfltr_range_filters']['pfr_grid'][zurr],
								pf_id: zurr
							};
