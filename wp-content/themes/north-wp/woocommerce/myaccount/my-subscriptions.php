...
<div class="small-12 small-centered medium-10 columns">
	<div class="smalltitle text-center"><?php echo apply_filters( 'woocommerce_my_account_my_subscriptions_title', __( 'My Subscriptions',THB_THEME_NAME ) ); ?></div>
	...
	<table class="shopping_bag">
		...
		<thead>
			<tr>
				...
				<th class="subscription-title"><span class="nobr"><?php _e( 'Subscription', THB_THEME_NAME ); ?></span></th>
				<th class="order-status"><span class="nobr"><?php _e( 'Status', THB_THEME_NAME ); ?></span></th>
				<th class="subscription-next-payment"><span class="nobr"><?php _e( 'Next Payment', THB_THEME_NAME ); ?></span></th>
				<th class="subscription-end"><span class="nobr"><?php _e( 'End Date', THB_THEME_NAME ); ?></span></th>
				<th class="order-actions"><span class="nobr"><?php _e( 'Actions', THB_THEME_NAME ); ?></th>
			</tr>
		</thead>
